const highlights = [
  {
    title: "Nested forms",
    description:
      "Playground supports nested forms using dot notation, allowing for easy access to nested objects within a form data structure.",
    img: (
      <svg
        width="32px"
        height="32px"
  ...
  },
  {
    title: "Validation",
    description:
      "Playground offers Yup or Zod validation options with the option for schema validation through the createForm function or inline validation through the register function.",
    img: (
      <svg
        fill="#2EC4B6"
        height="32px"
  ...
  },
  {
    title: "Flexible",
    description:
      "Playground is a form builder that allows you to create forms with custom fields and validation rules. It supports onSubmit, onChange, and debounced events and can be used in either controlled or uncontrolled mode for flexibility in form design.",
    img: (
      <svg
        width="32px"
        height="32px"
  ...
  },
  {
    title: "Easy",
    description:
      "Playground simplifies form creation in React with less code, eliminating the need for additional libraries like React Context or Redux. Sharing forms is easy with the hook created by the createForm function.",
    img: (
      <svg
        fill="#2EC4B6"
        width="32px"
  ...
  },
  {
    title: "Performance",
    description:
      "Playground offers efficient performance with just one render required to fulfill and submit a form. Unlike other form libraries that can be heavy and limited in form creation options, Playground allows for versatile form design while maintaining optimal performance.",
    img: (
      <svg
        width="32px"
        height="32px"
      ...
      >
        <g id="Lager_114" data-name="Lager 114" transform="translate(2)">
          <path
            id="Path_114"
            data-name="Path 114"
            d="M16,0A18,18,0,0,0-2,18a2,2,0,0,0,2,2,2,2,0,0,0,2-2,14,14,0,0,1,28,0,2,2,0,0,0,4,0A18,18,0,0,0,16,0Z"
            fill="#2EC4B6"
          />
          <g
            id="Ellipse_16"
          ...
          <path
            ...
            d="M2,0H2A2,2,0,0,1,4,2v9.125a0,0,0,0,1,0,0H0a0,0,0,0,1,0,0V2A2,2,0,0,1,2,0Z"
  ...
  },
  {
    title: "Effortless",
    description:
      "Playground makes it easy to share forms between different components in your React application through the hook created by the createForm function. ",
    img: (
      <svg
        width="32px"
        height="32px"
